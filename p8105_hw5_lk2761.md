...
converts it into a vector. I did not know how to create a dataframe from
pulling in the csv files from a data subdirectory, which is why I left
them all out in the main directory.
